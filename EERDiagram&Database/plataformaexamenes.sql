...
INSERT INTO `asignatura` VALUES (1,1,'Estudio de la cavidad oral',17),(2,2,'Dosimetría física y clínica',16),(3,2,'Empresa e iniciativa emprendedora',1),(4,1,'Ensayos fisicoquímicos',4),(5,2,'Ensayos biotecnológicos',4);
...
CREATE TABLE `examen` (
  ...
  `num_preguntas` int(6) NOT NULL DEFAULT 0,
...
INSERT INTO `examen` VALUES (2,'2021-05-25',1,3,12);
...
INSERT INTO `matricularse` VALUES (10,12,3);
...
INSERT INTO `pregunta` VALUES (5,2,'¿Cuantos euros son una libra?','1,18 euros',2);
...
INSERT INTO `usuario` VALUES (10,1,'Nobody','anon@gmail.com','Anonim','$2a$15$1YrLkhwIye7Ts1/Equ60YueVtRf/eqvgCH/8.rXAZUS48Vwe.7VXu','normal','anonimous'),(11,1,'database','admin.examenes@gmail.com','admin','$2a$15$Iiao5tVucDLNtkZ3l96ybeKw3AdfvSnYB0JuIEp.ZP4phlFrGKC5O','admin','admin'),(12,1,'Bonilla','angela.bonilla@gmail.com','Angela','$2a$15$WC7G52Xpn6tnt1pWTpLrW.sepdB/fNxKJWtsYhDIZ04iYsRvVVCD2','normal','angela');
...
-- Dump completed on 2022-05-18 16:30:45
