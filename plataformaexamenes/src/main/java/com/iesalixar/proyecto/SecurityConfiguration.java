...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/","/index/","/grados","/asignaturas").permitAll()
		.antMatchers("/home/*").authenticated()
		.antMatchers("asignaturas/addAsignatura/*","asignaturas/editAsignatura/*",
				"asignaturas/addAsignaturaGrado/*").hasRole("ADMIN")
		.antMatchers("/about","/services","asignaturas/addAsignaturaGrado/*").hasRole("USER")
