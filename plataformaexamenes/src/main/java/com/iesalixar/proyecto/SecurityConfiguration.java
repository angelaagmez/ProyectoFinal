...
import com.iesalixar.proyecto.services.JPAUserDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/","/index/","/asignaturas/*","/grados/*","/examenes/*","/preguntas/*").permitAll()
		.antMatchers("/asignaturas/*","/grados/*","/examenes/*","/preguntas/*","/matricularse/*").authenticated()
		.antMatchers("asignaturas/addAsignatura/*","asignaturas/editAsignatura/*",
				"grados/addGrado/*","grados/editGrado/*","/examenes/addExamen/*","/examenes/editExamen/*",
				"preguntas/addPregunta/*","preguntas/editPregunta/*").hasRole("ADMIN")
		.antMatchers("/about","/services","preguntas/addPregunta/*","preguntas/editPregunta/*",
				"/examenes/addExamen/*","/examenes/editExamen/*").hasRole("USER")
